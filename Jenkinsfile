    ...
    stage('Docker-Push-Multi') {
      ...
      steps {
        withCredentials([
          ...
          sh "docker tag ${IMAGE}:arm32v6-${META_TAG} ${IMAGE}:arm32v6-5.7"
          ...
          sh "docker push ${IMAGE}:arm32v6-5.7"
          sh "docker push ${IMAGE}:arm64v8-5.7"
          sh "docker manifest push --purge ${IMAGE}:5.7 || :"
          sh "docker manifest create ${IMAGE}:5.7 ${IMAGE}:amd64-5.7 ${IMAGE}:arm32v6-5.7 ${IMAGE}:arm64v8-5.7"
          sh "docker manifest annotate ${IMAGE}:5.7 ${IMAGE}:arm32v6-5.7 --os linux --arch arm"
